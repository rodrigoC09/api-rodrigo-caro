...
import foro.hub.api.rodrigo.caro.infra.security.DatosJWTToken;
import foro.hub.api.rodrigo.caro.infra.security.TokenService;
...
public class AutenticacionController {
    ...
    @PostMapping
    private ResponseEntity autenticarUsuario(@RequestBody @Valid DatosAutenticacionUsuario datosAutenticacionUsuario) {
